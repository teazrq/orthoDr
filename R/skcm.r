...
#' @usage skcm.clinical
#' @docType data
#' @format Contains 469 subjects with 156 failures. Each row contains one subject, subject ID is indicated by row name. Variables include `Time`, `Censor`, `Gender` and `Age`. `Age` has 8 missing values.
...
#' @references <http://bioinformatics.cing.ac.cy/MelGene/>
#' @references <https://cancergenome.nih.gov/>
